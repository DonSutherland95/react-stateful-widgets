...
export default function Input() {
  /* STEP 1 */
  const [inputValue, setInputValue] = useState(""); /*useState(value);*/
  ...
  const style = {
    fontSize: "1.5em",
    marginBottom: "0.3em" /* STEP 2 */,
    /*color: "royalblue"*/ color: inputValue.length > 10 ? "crimson" : " black",
  };
  ...
  return (
    <div className="widget-input container">
      ...
      {/* STEP 3 */ inputValue.toLocaleUpperCase()}
      <div>
        <input
          id="input"
          type="text"
